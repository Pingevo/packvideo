...
## ✔ ผลจริง (2026-08-08): **ผ่าน** — [รายละเอียด](../spikes/s1-mediarecorder/RESULT.md)

> ✅ อัด MP4/H.264 ได้ตรง · แบ่งชิ้นได้ ห่างสูงสุด **4.06 วิ** · ตัดชิ้นท้ายแล้วไฟล์ยังเปิดได้

| ผลต่อแผน | |
|---|---|
| คิวแปลงไฟล์กลางคืน | **ไม่ต้องทำ** — ตัดออกจากเฟส 2a (ประหยัด 2 วัน) |
| ค่า `timeslice` ใน P2a-3 | เปลี่ยนจาก 5000 ms เป็น **1000 ms** — ขอถี่กว่าได้ worst case ต่ำกว่าฟรีๆ เพราะเบราว์เซอร์รวบชิ้นให้เองอยู่แล้ว |
| ความเสี่ยง "transcode 1,500 คลิป/วัน" | **ตัดออกจากตาราง §9** |

**ยังไม่ได้ทดสอบ:** `getUserMedia` จากกล้องจริง · คลิปยาว 105 วิ · ภาระ CPU ตลอดกะ → ไปปิดที่ P2a-1
...
|---|---|---|
| ~~เบราว์เซอร์อัด MP4 ไม่ได้~~ | ~~S1~~ | ✔ **ปิดแล้ว — S1 ผ่าน** |
